	...
	public static void main (String[] args) { 
		...
		try {  
			...
			while ( (currentLine = bis.readLine()) != null) { 
				...
				// Keep updating the frame numbers and cumulative frame sizes for each type
				if(Ftype.equals("I")){
					iFrameNum++;
					iFrameSize += Fsize;
				}
			...
			// Compute average frame sizes
			System.out.println("I frame average size = " + iFrameSize/iFrameNum);
			System.out.println("P frame average size = " + pFrameSize/pFrameNum);
			System.out.println("B frame average size = " + bFrameSize/bFrameNum);
