...
[arrival_time, packetsize_p2, back_log] = textread('scheduler.txt1', '%f %f %f');
...
%3............. sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('output.txt1', '%f %f %f');
...
title('Number of Discarded packets for N=1');
xlabel('time (in microseconds)');
