...
%1......trace file
[packet_no_p, time_p, packetsize_p] = textread('output_movie.txt', '%f %f %f');
figure(1);
...
[arrival_time, packetsize_p2, back_log] = textread('scheduler.txt', '%f %f %f');
...
%3............. sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('output_poisson.txt', '%f %f %f');
